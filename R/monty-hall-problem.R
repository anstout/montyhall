...
#'   function.
#'
#' @return The function returns a number betwwn 1 and 3 that is either the first
...
#'   of all games.
#'
#' @param  ... the argument n= is used by the function to determine how many games
#'   will be played.
#'
